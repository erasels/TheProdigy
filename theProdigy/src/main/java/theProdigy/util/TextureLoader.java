...
import static theProdigy.TheProdigy.makeCardPath;
import static theProdigy.TheProdigy.makeUIPath;
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("theProdigyResources/images/ui/missing_texture.png");
            }
        }
