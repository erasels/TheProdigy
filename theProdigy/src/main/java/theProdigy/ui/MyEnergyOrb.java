...
import theProdigy.vfx.general.CalmFireEffect;
import theProdigy.vfx.general.CasualFlameParticleEffect;

import java.util.ArrayList;

public class MyEnergyOrb extends CustomEnergyOrb {
    public static final String[] orbTextures = {
            TheProdigy.makeCharPath("orb/layerFake.png"),
            TheProdigy.makeCharPath("orb/layerFake.png"),
            TheProdigy.makeCharPath("orb/layerFake.png"),
            TheProdigy.makeCharPath("orb/layerFake.png"),
            TheProdigy.makeCharPath("orb/layerFake.png"),
    ...
    private static final String VFXTexture = TheProdigy.makeCharPath("orb/EnergyRecharge.png");
